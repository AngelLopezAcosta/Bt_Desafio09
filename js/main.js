...
function Libro(titulo, autor, precio, isbn, pag, idioma, foto, sinop){
    this.titulo = titulo; 
    this.autor = autor;
    this.precio = precio;
    this.isbn = isbn;
        ...
        <article>
            <section id="libros">
                ...
                <div class="informacion">
                    <a href="img/677881.jpg" title="Click para ver imagen sola" target="_blank">
                        <img src="img/${this.foto}" alt="Sol de medianoche">
                    </a>
                    <p>
                        <span>Precio:</span>
...
//13
let elemLibros = document.getElementById('libros');
...
elemLibros.innerHTML += htmlNuevosLibros;



//console.log (libro2, libro3, libro4, libro5,);
